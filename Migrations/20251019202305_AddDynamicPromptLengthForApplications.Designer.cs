...
namespace DrzewaAPI.Migrations
{
    ...
    [Migration("20251019202305_AddDynamicPromptLengthForApplications")]
    partial class AddDynamicPromptLengthForApplications
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DrzewaAPI.Models.ApplicationTemplate", b =>
                {
                    ...
                    b.Property<int>("GeminiResponseMaxLength")
                        .HasColumnType("int");

                    b.Property<int>("GeminiResponseMinLength")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DrzewaAPI.Models.User", b =>
                {
                    b.OwnsOne("DrzewaAPI.Dtos.OrganizationDto", "Organization", b1 =>
                        {
                            ...
                            b1.OwnsOne("DrzewaAPI.Dtos.CorrespondenceDto", "Correspondence", b2 =>
                                {
                                    b2.Property<Guid>("OrganizationDtoUserId")
                                        .HasColumnType("uniqueidentifier");
