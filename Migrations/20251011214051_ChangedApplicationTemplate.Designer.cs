...
namespace DrzewaAPI.Migrations
{
    ...
    [Migration("20251011214051_ChangedApplicationTemplate")]
    partial class ChangedApplicationTemplate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DrzewaAPI.Models.Application", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("c6d5f2b5-bc4a-4f3d-9b68-000000000015"),
                            ApplicationTemplateId = new Guid("c6d5f2b5-bc4a-4f3d-9b68-000000000006"),
                        ...
                        new
                        {
                            Id = new Guid("c6d5f2b5-bc4a-4f3d-9b68-000000000016"),
                            ApplicationTemplateId = new Guid("c6d5f2b5-bc4a-4f3d-9b68-000000000005"),
                            CreatedDate = new DateTime(2024, 1, 15, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            FormData = "{}",
                            Status = "Draft",
            ...
            modelBuilder.Entity("DrzewaAPI.Models.TreeSubmission", b =>
                {
                    ...
                    b.PrimitiveCollection<string>("Environment")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.PrimitiveCollection<string>("Soil")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("TreeScreenshotUrl")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("DrzewaAPI.Models.ApplicationTemplate", b =>
                {
                    ...
                    b.OwnsOne("DrzewaAPI.Dtos.SignatureDto", "Signature", b1 =>
                        {
                            b1.Property<Guid>("ApplicationTemplateId")
                                .HasColumnType("uniqueidentifier");
